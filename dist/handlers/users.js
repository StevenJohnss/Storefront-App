...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, usernameExists, newUser, token, err_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 2:
                ...
                if (usernameExists)
                    res.send("user name taken please try another one");
                return [4 /*yield*/, store.create(user)];
            case 3:
                newUser = _a.sent();
                token = jsonwebtoken_1["default"].sign({ user: newUser }, process.env.TOKEN_SECRET, { expiresIn: "8h" });
                res.json(token);
                return [3 /*break*/, 5];
            case 4:
                err_1 = _a.sent();
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 2:
                u = _a.sent();
                if (u) {
                    token = jsonwebtoken_1["default"].sign({ user: u }, process.env.TOKEN_SECRET, { expiresIn: "8h" });
                    res.json(token);
                }
                else
                    res.send("Invalid Username Or password and my password is 123");
                return [3 /*break*/, 4];
            case 3:
                error_1 = _a.sent();
                res.status(401);
