...
var bookRoutes = function (app) {
    app.get('/products', utils_1.verifyAuthToken, index);
    app.get('/products/:id', utils_1.verifyAuthToken, show);
    app.post('/products', utils_1.verifyAuthToken, create);
    app["delete"]('/products', utils_1.verifyAuthToken, destroy);
};
