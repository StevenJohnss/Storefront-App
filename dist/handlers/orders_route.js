...
var userCurrentOrder = function (_req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userid, userCurrentOrders, err_3;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.userCurrentOrder(userid)];
            case 2:
                userCurrentOrders = _a.sent();
...
var bookRoutes = function (app) {
    app.get('/orders', utils_1.verifyAuthToken, index);
    app.get('/orders/:id', utils_1.verifyAuthToken, show);
    app.get('/orders/users/:user_id', utils_1.verifyAuthToken, userCurrentOrder);
    app.post('/orders', utils_1.verifyAuthToken, create);
    app["delete"]('/orders', utils_1.verifyAuthToken, destroy);
    // add product
    app.post('/orders/:id/products', utils_1.verifyAuthToken, addProduct);
};
