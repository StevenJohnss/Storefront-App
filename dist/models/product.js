...
var ProductStore = /** @class */ (function () {
    ...
    ProductStore.prototype.create = function (p) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, valArr, result, PRODUCT, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = "INSERT INTO products (name, price ".concat(p.id ? ", id" : "", ") VALUES($1, $2 ").concat(p.id ? ", $3" : "", " ) RETURNING *");
                        return [4 /*yield*/, database_1["default"].connect()];
                    case 1:
                        conn = _a.sent();
                        valArr = [p.name, p.price];
                        if (p.id)
                            valArr.push(p.id);
                        return [4 /*yield*/, conn
                                .query(sql, valArr)];
    ...
    ProductStore.prototype["delete"] = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var sql_delete_constraint, sql, conn, result, PRODUCT, err_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        sql_delete_constraint = "DELETE FROM order_products where product_id=".concat(id, ";");
